...
module.exports = function (token, orderId, callback) {
    ...
    parseXmlFile(xmlPath, function(xmlObject) {
        // Envelope data
        xmlObject['soap12:Envelope']['soap12:Body'][0]['GetOrderDetailsInfo_V2'][0]['Credentials'][0].Username = config.username
        xmlObject['soap12:Envelope']['soap12:Body'][0]['GetOrderDetailsInfo_V2'][0]['Credentials'][0].Password = config.password
        xmlObject['soap12:Envelope']['soap12:Body'][0]['GetOrderDetailsInfo_V2'][0]['Credentials'][0].Token = token
        xmlObject['soap12:Envelope']['soap12:Body'][0]['GetOrderDetailsInfo_V2'][0].OrderID = orderId
